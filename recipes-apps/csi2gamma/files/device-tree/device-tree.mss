...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = demosaic
 PARAMETER HW_INSTANCE = isp_0_v_demosaic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = framebuf_wr
 PARAMETER HW_INSTANCE = isp_0_v_frmbuf_wr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gamma_lut
 PARAMETER HW_INSTANCE = isp_0_v_gamma_lut_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipi_csi2_rx
